...
// 🛫 ২. ৩ডি ডাইস রোল কোর এপিআই রাউট (ভ্যারিয়েবল বাগ ফিক্সড মাস্টার ইঞ্জিন লক ভাই ভাই!)
app.post('/api/dice3d-shake', async (req, res) => {
    ...
    try {
        ...
        if (response.data && response.data.status === "ok") {
            ...
            // 🚀 [মাস্টার সিঙ্ক ফিক্সড]: ওরিজিনাল ওল্ড ফ্রন্টএন্ড চাবির নাম হুবহু (winSum এবং winningType) দিয়ে সার্ভার রেসপন্স রেডি ভাই ভাই!
            return res.json({
                success: true,
